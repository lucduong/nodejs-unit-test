        ...
        it('it should not POST a book without status field', (done) => {
            ...
            chai.request(server)
                ...
                .end((err, res) => {
                    res.should.have.status(200);
                    res.body.should.be.a('object');
                    // This one should be occurs error because there is no validate in POST function that author wrote before. I will comment bellow line to pass the case. Feel free to fix it by yourself.
